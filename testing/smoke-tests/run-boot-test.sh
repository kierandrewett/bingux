...
check "delta" "delta package listed/verified"
check "zoxide" "zoxide package listed/verified"
check "fzf" "fzf package listed/verified"
check "OK.*delta" "delta version check passed"
check "OK.*zoxide" "zoxide version check passed"
check "OK.*fzf" "fzf version check passed"
check "dust" "dust package listed/verified"
check "OK.*dust" "dust version check passed"
