...
- [ ] Discover local and system extension folders with per-extension errors.
- [ ] Load widget components through the existing desktop layout and preview system.
- [ ] Provide a lifecycle entry point and optional access to shell objects.
- [ ] Preserve placements when an extension is disabled, missing or incompatible.
- [ ] Test discovery, layout validation, previews, loading and unloading.
