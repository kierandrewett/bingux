...
window previews after 80 ms. Opening and closing use the shared popup motion;
the selection highlight slides between cards. Activation does not wait for an
