...
MonthGrid {
    ...
    delegate: Item {
        ...
        readonly property bool selected: root.highlightedDate !== null && model.date.getFullYear() === root.highlightedDate.getFullYear() && model.date.getMonth() === root.highlightedDate.getMonth() && model.date.getDate() === root.highlightedDate.getDate()
        readonly property bool keyboardFocused: root.visualFocus && model.date.getFullYear() === root.selectedDate.getFullYear() && model.date.getMonth() === root.selectedDate.getMonth() && model.date.getDate() === root.selectedDate.getDate()
        implicitWidth: 40
        implicitHeight: 40
        ...
        Rectangle {
            ...
            width: Math.min(36, dayCell.width)
            height: Math.min(36, dayCell.height)
            ...
            Rectangle {
                ...
                color: dayCell.model.today ? Qt.rgba(1, 1, 1, 0.16) : dayCell.selected ? Theme.pressed : Theme.hover
            }
            Text {
                anchors.centerIn: parent
