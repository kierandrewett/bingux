...
ShellPopup {
    ...
    function activate(entry) {
        ...
        if (entry.hasChildren) {
            parents = parents.concat([currentMenu]);
            currentMenu = entry;
            navigation.focusMenu();
        } else {
            entry.triggered();
    ...
    ColumnLayout {
        ...
        ListView {
            ...
            Keys.onRightPressed: if (currentItem && currentItem.modelData.hasChildren)
                navigation.activateCurrent()
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    ...
                    Text {
                        ...
                        text: entryButton.modelData.checkState === Qt.Checked ? "✓" : ""
                        color: Theme.accent
                    }
                    Text {
                        Layout.fillWidth: true
                    ...
                    Text {
                        text: entryButton.modelData.hasChildren ? "›" : ""
                        color: Theme.muted
                    }
                }
            }
