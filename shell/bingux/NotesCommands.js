...
var commands = [
    {
        id: "plain",
        title: "Text",
        hint: "Start a plain paragraph",
        aliases: "text plain paragraph",
    ...
    },
    {
        id: "bullet",
        title: "Bulleted list",
        hint: "A list with bullet points",
    ...
    },
    {
        id: "numbered",
        title: "Numbered list",
        hint: "A list with numbered steps",
        aliases: "num numbered list ordered",
    ...
    },
    {
        id: "todo",
        title: "To-do list",
        hint: "A checklist for tasks",
        aliases: "todo to-do checkbox task checklist",
    ...
    },
    {
        id: "table",
        title: "Table",
        hint: "Two columns with editable cells",
        aliases: "table columns rows grid",
    ...
    },
    {
        ...
        icon: "icons/format-quote-symbolic.svg",
        block: true,
        markdown: "> \u200b",
    },
    {
        id: "divider",
        title: "Divider",
        hint: "Separate sections with a line",
        aliases: "div divider separator horizontal rule",
    ...
    },
    {
        id: "code",
        title: "Code block",
        hint: "Keep code and spacing literal",
        aliases: "code fenced preformatted",
        icon: "icons/format-code-symbolic.svg",
        block: true,
        markdown: "```\n\u200b\n```",
    },
    {
    ...
    },
    {
        id: "italic",
        title: "Italic",
        hint: "Write italic text",
        aliases: "italic italics emphasis",
    ...
    },
    {
        id: "inlineCode",
        title: "Inline code",
        hint: "Code within a sentence",
        aliases: "inline code monospace",
        icon: "icons/format-code-symbolic.svg",
        markdown: "`code`",
        select: "code",
    },
    {
        id: "link",
        title: "Link",
        hint: "Insert and edit a Markdown link",
        aliases: "link url web bookmark book",
    ...
    },
    {
        id: "image",
        title: "Image",
        hint: "Insert a Markdown image URL or file path",
        aliases: "image picture photo",
        icon: "insert-image-symbolic",
        input: "![Image description](file:///path/to/image.png)",
        select: "file:///path/to/image.png",
    },
    {
        id: "date",
        title: "Date",
    ...
    },
    {
        ...
        hint: "Copy the current paragraph below it",
    ...
    },
    {
        id: "delete",
        title: "Delete block",
        hint: "Remove the current paragraph",
