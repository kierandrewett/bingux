...
SearchOverlay {
    ...
    property var sample: ({
            ...
            kind: "application",
            title: "Launch animation test",
            subtitle: "No application is launched",
    ...
    Timer {
        ...
        running: true
        onTriggered: {
            preview.displayedResults = [preview.sample];
    ...
    Timer {
        ...
        running: true
        onTriggered: {
            preview.animateActivation(preview.sample);
            preview.closeSearch();
        }
    }
    Timer {
    ...
    Timer {
        ...
        running: true
        onTriggered: {
            preview.check(!preview.visible && !preview.closing, "window closes after icon finishes");
            Qt.quit();
        }
    }
}
