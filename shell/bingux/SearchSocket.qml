...
QtObject {
    ...
    function isCommonRecord(record) {
        return isObject(record) && record.protocolVersion === protocolVersion && typeof record.type === "string";
    }
    ...
    function nextRequestId(prefix) {
        requestSequence = (requestSequence + 1) % 1e+06;
