...
Item {
    ...
    readonly property var presentation: DesktopLayout.presentation(DesktopEditing.desktop, widgetId, DesktopLayout.placement(DesktopEditing.desktop, widgetId), spec.label, spec.icon, widgetId.startsWith("icon"), widgetId.startsWith("label"))
