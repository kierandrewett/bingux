...
Scope {
    ...
    readonly property point followedPosition: {
        ...
        if (hostItem) return anchorItem.mapToItem(hostItem, anchorItem.width / 2, anchorItem.height);
    ...
    PanelWindow {
        ...
        margins.top: !root.hostItem && root.barWindow?.anchors.bottom && !root.barWindow?.anchors.top
