    ...
    TestCase {
        ...
        function test_native_media() {
            try {
                ...
                drag(media, media.width - 4, 4, Qt.point(dockArea.screenRect.x + 12, dockArea.screenRect.y + 12));
                ...
                editor.undo();
                wait(200);
                compare(media.parent, originalParent);
                compare(play.parent, transport);
                editor.redo();
                wait(200);
                compare(media.parent, dock.widgetHost);
                editor.apply();
                ...
                popup.visible = false;
                tryCompare(media, "inlineControls", true, 3000);
                editor.open();
                editor.put("control-media", "top-left", 0);
                ...
                editor.selectedWidget = "control-media";
                editor.widgetOption("label", "Now playing");
