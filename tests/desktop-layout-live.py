...
with tempfile.TemporaryDirectory(prefix='bingux-layout-live-') as directory:
    ...
    with (fixture / 'search-runtime.log').open('w') as search_log:
        ...
        try:
            ...
            if case in ('control-groups', 'control-connectivity', 'control-utilities', 'control-external', 'control-capture', 'settings-recovery', 'sidebar-layout', 'sidebar-controls', 'editor-reset', 'panel-placement', 'metrics-placement', 'tray-placement', 'overflow-edit'):
