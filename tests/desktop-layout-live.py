...
parser.add_argument('--case', choices=('extensions', 'desktop-layout', 'control-layout', 'control-audio', 'control-media', 'control-groups', 'control-connectivity', 'control-utilities', 'control-external', 'control-capture', 'settings-recovery', 'sidebar-layout', 'sidebar-controls', 'sidebar-panels', 'editor-reset', 'dock-unpin', 'panel-placement', 'editor-compact', 'editor-save-input', 'metrics-placement', 'tray-placement', 'overflow-edit', 'overflow-detached'), default='desktop-layout')
...
with tempfile.TemporaryDirectory(prefix='bingux-layout-live-') as directory:
    ...
    if case in ('extensions', 'control-layout', 'control-groups', 'control-utilities', 'sidebar-controls'): shell = 'import "ControlLayout.js" as ControlLayout\n' + shell
    if case == "control-connectivity": shell = "import Quickshell.Bluetooth\n" + shell
    base_shell = shell
    ...
    with (fixture / 'search-runtime.log').open('w') as search_log:
        ...
        try:
            ...
            if case in ('extensions', 'control-groups', 'control-connectivity', 'control-utilities', 'control-external', 'control-capture', 'settings-recovery', 'sidebar-layout', 'sidebar-controls', 'editor-reset', 'panel-placement', 'metrics-placement', 'tray-placement', 'overflow-edit'):
