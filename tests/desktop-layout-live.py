...
parser.add_argument('--case', choices=('desktop-layout', 'control-layout', 'control-audio', 'control-media', 'control-groups', 'control-utilities', 'control-external', 'sidebar-layout', 'sidebar-controls', 'sidebar-panels', 'editor-reset', 'dock-unpin', 'panel-placement', 'editor-compact', 'editor-save-input', 'metrics-placement', 'tray-placement'), default='desktop-layout')
...
with tempfile.TemporaryDirectory(prefix='bingux-layout-live-') as directory:
    ...
    with (fixture / 'search-runtime.log').open('w') as search_log:
        ...
        try:
            ...
            if case in ('control-groups', 'control-utilities', 'control-external', 'sidebar-layout', 'sidebar-controls', 'editor-reset', 'panel-placement', 'metrics-placement', 'tray-placement'):
