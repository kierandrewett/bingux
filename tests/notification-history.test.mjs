...
const entry = {notification: {id: 1}, historyKey: 'old:1', receivedAt: 12, desktopEntry: 'discord-canary', appName: 'Discord Canary', summary: 'Marc', body: 'Cooking', image: 'file:///avatar.png', actions: [{action: {invoke() {}}}]};
