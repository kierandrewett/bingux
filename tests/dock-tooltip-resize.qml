        ...
        function test_switch() {
            ...
            for (let n = 0; n < 80; ++n) {
                ...
                for (let sample = 0; sample < 30; ++sample) {
                    ...
                    check(column.y + column.height <= bubble.height,
                        "Text overflowed the tooltip bottom during resize");
                    check(label.contentWidth <= label.width + 1,
                        "Text overflowed the tooltip width during resize");
                }
