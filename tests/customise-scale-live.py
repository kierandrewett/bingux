...
parser.add_argument(
    "--cases",
    nargs="+",
    choices=["editor-compact", "control-external", "sidebar-layout"],
    default=["editor-compact", "control-external"],
)
...
for scale in args.scales:
    ...
    print(
        f"SCALE {scale}: {environment['BINGUX_TEST_SCREEN_WIDTH']}x{environment['BINGUX_TEST_SCREEN_HEIGHT']}",
        flush=True,
    )
